...
def add_building():
    ...
    tempa_args = subject_methods["tempa"].get(tempa_combo.currentText(), 1)
...
labels = [create_label(text) for text in [
    'Тип строения', 'Высота', 'Длина', 'Ширина',
